...
CLOSE_GATE_FAMILIES = ("sector", "stock")  # shared Close model has no usable |q50c|
...
RECENT_CLOSE_MAE_SOFT = 0.018  # full size below this; strip high_confidence above
RECENT_CLOSE_MAE_MAX = 0.025  # at/above this → minimum size scale (not hard flat)
RECENT_MAE_SIZE_MIN = 0.25  # floor on paper size_scale when recent MAE is poor
MAX_POSITIONS = 10
